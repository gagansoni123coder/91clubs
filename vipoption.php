...
$sql3 = "SELECT period FROM vipperiod WHERE id='1'";
...
$sql2 ="INSERT INTO vipbetting (username,period,ans,amount) VALUES ('".$_SESSION['username']."', $period,'$ans',$amount)"; 
$sql="UPDATE users SET  balance = '$newbalance' WHERE username='".$_SESSION['username']."'" ;
$conn->query($sql);              
if ($conn->query($sql2) === TRUE) {
    header("location: win3");
