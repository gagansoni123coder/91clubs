...
<h2 style="font-size:20px;padding:5px; color:black; text-align:center;"onclick="window.location.href='unban'"> Click Here for unban</h2>
<h2 style="font-size:20px;padding:5px; color:black; text-align:center;"onclick="window.location.href='ban'"> Click Here for ban</h2>
...
<a href="https://t.me/Wipro_app" class="float">
