...
.popup {
    ...
    transition: all 5s ease-in-out;
			...
			if (cfg) {
				...
				link.href = cfg.WebIco;//'http://47.56.7.183:5001/https://91club.club/img/tatalogo.jpg';
