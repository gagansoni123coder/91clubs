...
$query =  "SELECT * FROM emredbetting ORDER BY id DESC";
...
$query = "SELECT *FROM emredbetting WHERE username='".$_SESSION['username']."' ORDER BY id DESC LIMIT " . $page_first_result . ',' . $results_per_page;  
$result = mysqli_query($conn, $query);
