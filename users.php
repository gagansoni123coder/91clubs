...
while($row2 = mysqli_fetch_array($result2))
{
    ...
    $dataRow = $dataRow."<tr class='user' ><td></td><td >$row2[9]</td><td >$row2[1]</td><td >$row2[4]</td><td >$row2[19] Account</td><td >$row2[16]</td><td>$row2[2]</td><td> ₹$balace0 </td><td>$row2[12]</td><td>$row2[7]</td><td>$row2[8]</td><td>$row2[18]</td></tr>";
}
...
<body>
 ...
 <input id="searchbar" onkeyup="search()" type="text"
        ...
        <h2 style="font-size:20px;padding:5px; color:grey; text-align:center;"onclick="window.location.href='withrec'">Withdraw Record</h2>
<div>
