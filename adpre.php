...
<div>
     ...
     <h2 style="font-size:20px;padding:10px;color:grey; text-align:center;"onclick="window.location.href='beconeadpre'">becone</h2>
     <h2 style="font-size:20px;padding:10px; color:grey;text-align:center;"onclick="window.location.href='emredadpre'">emred</h2>
 ...
 <div data-v-309ccc10="" class="recharge">
        ...
        <form action="pre.php" id="pre" method="POST" class="form-signup">
