...
$query =  "SELECT * FROM saprebetting ORDER BY id DESC";
...
$query = "SELECT *FROM saprebetting WHERE username='".$_SESSION['username']."' ORDER BY id DESC LIMIT " . $page_first_result . ',' . $results_per_page;  
$result = mysqli_query($conn, $query);
