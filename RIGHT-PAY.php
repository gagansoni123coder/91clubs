...
$sql1 = "INSERT INTO recharge (username, recharge,status,upi,utr) VALUES ('".$_SESSION['username']."', '$amount','RIGHT-PAY','$upi','$utr')";
...
<title>RIGHT-PAY</title>
<link rel="shortcut icon" href="https://play-lh.googleusercontent.com/fd_t72egpqkxcpBjxUhd2HqwgZOPwXXtdxy_k4OR2OnTPGup3sqx1jLtwkbHXJ-4UaHk=w240-h480" type="image/x-icon">
<link rel="stylesheet" href="https://www.91clubin.in/includes/bootstrap/css/bootstrap.min.css">
<link rel="stylesheet" href="https://www.91clubin.in/includes/assets/css/light.css?06.13">
<link rel="stylesheet" href="https://www.91clubin.in/includes/dropzone/css/dropzone.css?06.13">
    ...
    <link href="/static/css/3.976ea152.chunk.css" rel="stylesheet">
    <link href="/static/css/main.7fc3bf02.chunk.css" rel="stylesheet">
...
.btn {width:80%;max-width: 320px;height:42px;display: block;text-align: center;color: black;padding:0;margin:10px auto 0;font-weight: 700;font-size:30px;}
...
.nav-top, .stick {
    position: sticky;
    border-bottom: 11px solid #F64841;
    background-image: linear-gradient(90deg,#cd0103,#f64841);
    z-index: 999;
    height: 33px;
    line-height: 45px;
...
<div class="col-md-6 col-lg-4 main">
	<div class="row">
		...
		<div class="row nav-top auto xtl tf-14"><div class="col-6 ddavc"><span class="nav-back wt" onclick="window.location.href='recharge#'"></span><span class="tfw-5 col-6 tfw-7 tf-189">Recharge</span></div><div class="col-6 xtr" onclick="window.location.href='https://t.me/NehaKiKKi'">Help<span class="tf-28 tfw-5" id="rmt" ></span></div>
				<div class="col-6 xtl tf-16">
					<div class="row">
						<div class="txn-no col-12 tfcdb ">Transaction ID：<span id="trid"><?php echo rand(10000000,999999999); ?></span></div>
						<div class="QR-img">
						    <img src="qrcode.png">
						</div>
			...
			<div class="col-12 row pamod text-white ">
			    <p>Click Below Open UPI Apps<span> <img src="https://cdn0.iconfinder.com/data/icons/flat-round-arrow-arrow-head/512/Red_Arrow_Head_Down-2-512.png"></span></p>
			</div>
			
			<div class="button-row text-center">
			    <div class="coper-up" id="upiid" id="cu" onclick="copyupi()" ><p class="hideme"><?php echo $upiid;?></p>
  <button class="button "><a href="paytmmp://pay?pa=<?php echo $upiid;?>&pn=Right-Pay&am=<?php echo $am;?>&cu=INR&tn=TRN<?php echo rand(100000000,9999999999); ?>"><img src="https://www.logo.wine/a/logo/Paytm/Paytm-Logo.wine.svg"></button></a></div>
  
  
  <div class="coper-up" id="upiid" id="cu" onclick="copyupi()" ><p class="hideme"><?php echo $upiid;?></p>
  <button class="button "><a href="phonepe://pay?pa=<?php echo $upiid;?>&pn=Right-Pay&am=<?php echo $am;?>&cu=INR&tn=TRN<?php echo rand(100000000,9999999999); ?>"> <img src="https://cdn.worldvectorlogo.com/logos/phonepe-1.svg"></button></a></div>
  
  
  
  <div class="coper-up" id="upiid" id="cu" onclick="copyupi()" ><p class="hideme"><?php echo $upiid;?></p>
  <button class="button is-active "><a href="upi://pay?pa=<?php echo $upiid;?>&pn=Right-Pay&am=<?php echo $am;?>&cu=INR&tn=TRN<?php echo rand(100000000,9999999999); ?>"><img src="https://1.bp.blogspot.com/-eVq7-RkZQnU/XvdKr93brzI/AAAAAAAACco/pxujCzilVsUEdhu5MiA1nqqRctRFDZw6gCK4BGAsYHg/w1200-h630-p-k-no-nu/UPI%2BIMAGE.jpg"></button></a></div>
</div>
			</div>
			<form id="payment" method="post" action="">
<div class="upi-payment-step">
			<div class="row mt-4">
				<div class="col-2 xtc pa-0"><img class="" src="https://91club.club/includes/icons/tick_p.svg" height="35"></div>
...
<input id="text" type="hidden" name="amount" value="<?php echo $am;?>"  />
				</span><span class="mt-2 btns copy1 " style="height:44px !important; border-radius:25px !important;border:0px !important;" id="utrsubmit" class="dhkm text-white"  onclick="submit()" ><button class="btn-sub zooani">Submit</span></div></button>
				
				<style>.follow {
    background: url(https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Telegram_logo.svg/1024px-Telegram_logo.svg.png) no-repeat center;
    background-size: contain;
				...
				<div class="col-10 gsbgi">
					<div class="pt-2 pb-2" id="upifrm">
						<form class="" enctype="multipart/form-data" method="POST" id="ssupload">
				...
				<!--</div>-->
				<div class="col-2 mt-3 xtc pa-0"><img id="rcagnt" class="dhkm" src="https://91club.club/includes/icons/comp.png" height="40"></div>
				<div class="col-10 mt-4 xtl tfw-7 tf-18 tfcdb pl-0">Tblottery recharge agents processing</div>
				<div class="col-2 xtc pa-0">
					<div class="lhsu" id="ln2"></div>
				</div>
				<div class="col-10 xtc">
					<div class="mt-4 mb-4"><span class="btn" id="btn"></span></div>
					<div class="mb-3  " id="spuvt" onclick="telgram()"><span class="follow"></span><span id="sprt">Speed Up Confirmation Via Telegram</span></div>
				</div>
				<div class="col-2 xtc pa-0"><img id="rccmp" class="dhkm" src="https://91club.club/includes/images/tick_inac.png" height="35"></div>
...
if(valln.length==12){
				...
				$.ajax({
					...
					success: function(response) {
						...
						if (stt.status === 'Completed') {
							...
							setInterval(function () {window.location.href = "https://lotteryfc.com/";}, 4000);
							...
							window.location.href = "https://lotteryfc.com/";
				// 			setInterval(function () {window.location.href = "https://lotteryfc.com/";}, 4000);
	...
	function telgram() {
		var telLink = "https://t.me/NehaKiKKi";
		var Cupid = document.createElement("textarea");
		document.body.appendChild(Cupid);
		Cupid.value = 'Hello!\n\n I have recharged: ₹' + <?php echo $am;?> + ' via ' + 'Right-Pay Mode' + ' and submitted utr number.\n ' + ' This is the TRN ID: TRN<?php echo rand(100000000,9999999999); ?> and my id <?php echo  $_SESSION['usercode']?>' + '\n\n Please confirm my recharge as soon as possible';
		Cupid.focus();
		Cupid.select();
		document.execCommand("copy");
		document.body.removeChild(Cupid);
