...
$query =  "SELECT * FROM vipbetting ORDER BY id DESC";
...
$query = "SELECT *FROM vipbetting WHERE username='".$_SESSION['username']."' ORDER BY id DESC LIMIT " . $page_first_result . ',' . $results_per_page;  
$result = mysqli_query($conn, $query);
